...
#include <jni.h>
/* Header for class com_noweaj_android_pupildetection_core_opencv_OpencvNative */

#ifndef _Included_com_noweaj_android_pupildetection_core_opencv_OpencvNative
#define _Included_com_noweaj_android_pupildetection_core_opencv_OpencvNative
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_noweaj_android_pupildetection_core_opencv_OpencvNative_ConvertRGBtoGray
